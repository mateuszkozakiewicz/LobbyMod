...
function CreateReclaimLabel(view)
    ...
    label.DisplayReclaim = function(self, r)
        ...
        if self.oldMass > 5000 then
            self.text:SetFont('Arial Gras', 18)
            self.text:SetColor('ffd00000')
        elseif self.oldMass > 1000 then
            self.text:SetFont('Arial Gras', 15)
            self.text:SetColor('ffe54e27')
        elseif self.oldMass > 300 then
            self.text:SetFont('Arial Gras', 12)
            self.text:SetColor('ffe58727')
        end
